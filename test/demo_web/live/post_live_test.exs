defmodule DemoWeb.PostLiveTest do
  ...
  @create_attrs %{title: "some title", body: "some body", date_published: "2023-11-20"}
  @update_attrs %{title: "some updated title", body: "some updated body", date_published: "2023-11-21"}
